<html>
<head>
<title>NETRA Eye Care Hospital, Vijaynagar, Sangli 416410</title>
...
<script>
var check = function() {
if (document.getElementById('password').value == document.getElementById('cpassword').value) { document.getElementById('message').style.color = '#5dd05d'; document.getElementById('message').innerHTML = 'Matched';
} else {
document.getElementById('message').style.color = '#f55252'; document.getElementById('message').innerHTML = 'Password fields doesnot match';
}
}
...
function checklen()
{
var pass1 = document.getElementById("password"); if(pass1.value.length<6){
alert("Password must be at least 6 characters long. Try again!"); return false;
}
}
</script>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #e3f2fd;" id="mainNav" >
<div class="container">
<a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif; color: black;"><h4><img src="images/logo.png" alt="Logo" width="38" height="33" class="d-inline-block align-text-top">&nbsp NETRA Eye Care</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif; background-color: #e3f2fd;">
<div class="col-md-9 register" style="margin-top: 40px;left: 80px;">
...
<a href="patient_login.php">Already have an account? Login Now</a>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
